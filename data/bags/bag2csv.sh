...
rostopic echo -b joint_position_real_0911.bag -p /franka_state_controller/joint_position > joint_position_real_demo.csv
rostopic echo -b joint_velocity_real_0911.bag -p /franka_state_controller/joint_velocity > joint_velocity_real_demo.csv
